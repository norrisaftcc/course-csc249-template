...
class Course:
    ...
    def __init__(self, name: str, code: str, credits: int,
        ...
        # In Python, we use underscore prefix (_name) to indicate "private"
        # (though Python doesn't enforce privacy like C++ does).
        #
        # HINT: Use the setters where appropriate (especially for credits)
        #       to ensure validation is applied consistently.

        pass  # Remove this and add your initialization code
